...
class App(tk.Frame):
    def __init__(self, master=None):
        ...
        self.mode_train = tk.Radiobutton(self, text="Train", variable=self.mode_var, value="train")
        self.mode_train.grid(row=0, column=1)
        self.mode_infer = tk.Radiobutton(self, text="Infer", variable=self.mode_var, value="infer")
        self.mode_infer.grid(row=0, column=2)
        ...
        self.model_label.grid(row=1, column=0, padx=10)
        ...
        self.epochs_label.grid(row=2, column=0, padx=10)
        ...
        self.batch_size_label.grid(row=3, column=0, padx=10)
        self.batch_size_var = tk.StringVar(value="32")
        self.batch_size_entry = tk.Entry(self, textvariable=self.batch_size_var)
        self.batch_size_entry.grid(row=3, column=1)
        ...
        self.checkpoint_label.grid(row=4, column=0, padx=10)
        ...
        self.possible_target_label.grid(row=5, column=0, padx=10)
        ...
        self.possible_target_entry.grid(row=5, column=1)

        # Figures parameter
        self.figures_label = tk.Label(self, text="Figures:")
        self.figures_label.grid(row=6, column=0, padx=10)
