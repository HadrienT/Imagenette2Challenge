...
class Model(nn.Module):
    def __init__(self, num_class) -> None:
        ...
        self.conv2 = nn.Conv2d(in_channels=3, out_channels=8, kernel_size=(5,5), stride=1, padding=0)
        self.fc1 = nn.Linear(in_features=8*61*61, out_features=120)
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 8 * 61 * 61) #flatten the tensor
